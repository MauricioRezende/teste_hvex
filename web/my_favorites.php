		    ...
		    foreach ( $itens as $e ) {
		        ...
		        ?>
					<tr>
						...
						<td><a class="modal-trigger" href="#modal<?php echo $cont; ?>" style="color:gray;"><i class="material-icons right tooltipped shake" data-position="top" data-tooltip="See details">search</i></a></td>
